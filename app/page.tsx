  ...
  return(
    <div>
      ...
      <ul className="p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {items.map((item) => (
          <li key={item.id}>
            <div className="w-68 h-80 shadow-xl/30 p-4 rounded bg-zinc-800 flex flex-col">
              ...
              <p className="mt-4 text-white flex-1 overflow-hidden text-ellipsis">{item.description}</p>
               <button
                  onClick={openModal} 
